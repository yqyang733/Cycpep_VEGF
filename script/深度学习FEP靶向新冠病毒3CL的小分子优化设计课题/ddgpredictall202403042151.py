...
class config:
    ...
    def __init__(self):
        ...
        self.train = os.path.join("./all_data/train_1.csv")
...
class DD_Model:
    ...
    def train(self, train_data):
        ...
        run_log = open(os.path.join(self.result_folder, "run_log.dat"), "w")
        ...
        for epo in range(train_epoch):
            run_log.write("Epoch: " + str(epo) + "\n")
            for j in range(num_train):
                run_log.write("  j: " + str(j) + "\n")
                run_log.flush()
                start = j*2560
            ...
            self.save_model("./model/model_epoch" + str(epo))
...
def run():
    ...
    conf = {"drug_encoding": "MPNN",
            ...
            "result_folder": os.path.join("./model/"),
            "train_epoch": 60,
            "LR": 0.001,
            "decay": 0.00001,
            "batch_size": 64,
