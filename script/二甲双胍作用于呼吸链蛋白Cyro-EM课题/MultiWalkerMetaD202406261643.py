...
cd prod
if [ ! -f prod.gro ];then
    gmx_mpi grompp -f ../../mdp/prod.mdp -c ../win_{0}.gro -p ../../topol.top -o prod.tpr -r ../win_{0}.gro -maxwarn 4 -n ../../index.ndx
    gmx_mpi mdrun -s prod.tpr -deffnm prod -dhdl dhdl -nb gpu -bonded gpu -pme gpu -gpu_id 0 -pf prodf.xvg -px prodx.xvg -nsteps 2500000 -plumed ../plumed.dat
fi
