...
class config:
    ...
    def __init__(self):
        ...
        self.title = ""
        self.queue = "single"
        self.system_pdb = os.path.join("../common/complex.pdb")
        self.system_psf = os.path.join("../common/complex.psf")
        ...
        self.npt_step = "500000"                       # timestep: 2fs
        self.prod_step = "5000000"                      # timestep: 2fs  
...
def run():
    ...
    generate_prodstep_config("../common/complex.pdb", "../common/complex.psf", settings.ff_path, settings.prod_step, "5000")
